export const passwordUpdated = (email, name) => {
  return `<!DOCTYPE html>
    ...
    <body>
        <div class="container>
            <a href="https://learnwell-edtech-project.vercel.app">
                <img class="logo" src="https://i.ibb.co/7Xyj3PC/logo.png" alt="LearnWell Logo"> 
            </a>
            <div class="message">
            ...
            <div class="support">
                ...
                <a href="mailto:info@learnwell.com">info@learnwell.com</a>. We are here to help!
            </div>
        </div
    </body>
