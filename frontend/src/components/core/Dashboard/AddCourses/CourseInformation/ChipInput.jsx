  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <p className="text-xs text-richblack-300">
        Add keywords that describe the course, then press Enter. Example: Web
        Development, React, JavaScript, MERN, Beginner.
      </p>
      ...
      {errors[name] && (
        <span className="ml-2 text-xs tracking-wide text-pink-200">
          Add at least one tag, for example React, JavaScript, Python, UI/UX,
          Data Science.
        </span>
      )}
    </div>
